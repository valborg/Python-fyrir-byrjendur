...
\begin{center}
	\includegraphics[scale=0.6]{doodles31-07.png}
\end{center}
%\end{wrapfigure}
...
Útfærslan felst í tveimur hreiðruðum for-lykkjum.
\footnote{Það er yfirleitt ekki góðs viti þegar kemur að tímaflækju, enda er hægt að gera ráð fyrir að tíminn sem það tekur að keyra bubble sort sé $n^2$, sem segir kannski ekkert fyrir óþjálfað auga en hægt er að treysta því að það er ekki ákjósanlegt.}
...
%\begin{wrapfigure}{i}{0.2\textwidth} %i o r l 
\begin{center}
	\includegraphics[scale=1.0]{doodles31-25.png}
\end{center}
%\end{wrapfigure}
...
\footnote{Tölvunarfræðingar eru mjög uppteknir af því hvað aðgerðir og reikningar taka mikinn tíma.
