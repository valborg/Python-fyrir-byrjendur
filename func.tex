...
Dæmi væri: def prentunarfall(strengur): print(stremgur).
...
Dæmi væri def prentunarfall(strengur = "Halló Heimur!"): print strengur.
...
Sjáum þetta í kóðabút \ref{lst:foll-sjalfgefin}, hvernig megi nota bæði stöðubundin og sjálfgefin saman og hvernig megi kalla í föll sem eru með 
...
Nú höfum við séð hvernig á að búa til föll, við höfum séð hvernig á að láta föllin vinna með sjálfgefið inntak og 
