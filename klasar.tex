...
citroen = Bíll()
print(citroen.tegund)
subaru = Bíll()
subaru.tegund = "Subaru"
print(subaru.tegund)
\end{lstlisting}
\lstset{style=uttak}
\begin{lstlisting}
...
Hugsum okkur að við búum til skilgreiningu á bíl, hann þarf að vera af einhverri tegund og hafa árgerð og skoðum línur 1-3 í kóðabút \ref{lst:klasar-skilgreindir}.
Svo viljum við fá tilvik af skilgreiningunni í hendurnar (lína 5), þá búum okkur til breytu sem fær gildi eins og við höfum gert hundrað sinnum áður, nema núna er gildið sem breytan fær nafnið á klasanum okkar ásamt svigum eins og við séum að kalla í hann.
...
Segjum að við fáum okkur svo annan bíl, þá getum við búið til aðra breytu sem inniheldur aðra tegund og annað módel (lína 7).
...
En þessi skilgreining innihélt engar aðferðir svo það er ekki hægt að framkæma aðra aðgerð en að breyta eigindum (lína 8).
