...
% Á eftir að gera athugasemd utan um þetta
...
\input{strengurlausnir.tex}
\input{listarlausnir.tex}
\input{expressionlausnir.tex}
\input{lykkjurlausnir.tex}
\input{ndlausnir.tex}
\input{dictlausnir.tex}
\input{setlausnir.tex}
\input{funclausnir.tex}
\input{importlausnir.tex}
\input{skjollausnir.tex}
\input{klasarlausnir.tex}
\input{villurlausnir.tex}
\input{reikniritlausnir.tex}
\input{devlausnir.tex}
%----------------------------------------------------------------------------------------
%	INDEX
%----------------------------------------------------------------------------------------
