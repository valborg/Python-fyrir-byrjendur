...
Fallið \texttt{range()} tekur við sömu viðföngum eins og hornklofarnir\footnote{Það eru í raun ekki viðföng, í "strengur"[1:5:2] eru 1, 5, og 2 ekki viðvöng beinlínis heldur vísar.} þegar við sóttum nokkur tákn upp úr streng eða lista, þau eru þó aðgreind með kommum.\footnote{Við höfum áður séð viðföng notuð í falli eins og \texttt{print()} fallið, þar sem við getum prentað margt út svo lengi sem við setjum kommur á milli.}
