...
\begin{lstlisting}[caption=while lykkja sem keyrir að eilífu, label=lst:lykkjur-while]
while(True):
...
\end{lstlisting}
\lstset{style=venjulegt}
Lykkjan í kóðabút \ref{lst:lykkjur-while} keyrir að eilífu vegna þess að skilyrðið fyrir henni er \texttt{True} og ekkert breytir því í stefi hennar.
