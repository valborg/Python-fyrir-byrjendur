...
\begin{figure}[!h]
	...
	Þetta veldur því að aðaláherslan virðist nú vera að komast að því hvort eigi að kaupa kex eða ekki og mjólkurstaðan er athuguð fyrst af einhverri ástæðu}
...
# Við áttum mjólk svo þetta prentast ekki, við förum framhjá aðgerðunum sem eru undir þessari if skipun
\end{lstlisting}
...
\subsection{Hreiðrun}\index{Hreiðrun}
