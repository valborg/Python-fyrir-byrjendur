...
\begin{center}
	\includegraphics[scale=0.65]{doooodles_valborg-12.png}
\end{center}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance=1cm]
		...
		\draw [arrow] (annars1) -| node[anchor=south] {ósatt} (annars2);
		\draw [arrow] (annars2) -| node[anchor=south] {ósatt} (annars3);
		...
		\draw [arrow] (annars2) -- node[anchor=west] {satt} (annars2s);
