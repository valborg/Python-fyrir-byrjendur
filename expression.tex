...
\begin{wrapfigure}{I}{0.2\textwidth} %i o r l 
	\begin{center}
		\includegraphics{doooodles_valborg-12.png}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{I}{0.25\textwidth} %i o r l 
	\begin{center}
		\includegraphics{doooodles_valborg-05.png}
	\end{center}
\end{wrapfigure}
...
Það sem á að framkvæma undir ef setningunni/if yrðingunni er inndregið um fjögur bil eða einu sinni á ,,tab'' takkann\footnote{Hann er fyrir ofan ,,CapsLock'' takkann.}.\todo{er að tala um tab takkann}
...
Í kóðabútnum tökum við fyrir segðina ,,er til mjólk?'' og veitum henni gildið \texttt{True} svo við erum stödd í þeim aðstæðum að við eigum vissulega til mjólk, skoðið töflu \ref{tbl:sanntafla-kaffi} til að sannfærast og það sem er að gerast.
...
\begin{wrapfigure}{o}{0.2\textwidth} %i o r l 
	\begin{center}
		\includegraphics{doooodles_valborg-08.png}
	\end{center}
\end{wrapfigure}
