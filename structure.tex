...
\definecolor{laurple}{RGB}{180, 178,  214}
...
\newcommand{\@mypartnumtocformat}[2]{%
	...
	\noindent\colorbox{ocre!20}{\strut\parbox[c][1.3cm]{\ecart}{\color{ocre!70}\Large\sffamily\bfseries\centering#1}}\hskip\esp\colorbox{ocre!40}{\strut\parbox[c][1.3cm]{\linewidth-\ecart-\esp}{\Large\sffamily\centering#2}}%
}
...
%\node[anchor=north] at (3cm,-5.25cm){\color{ocre!40}\fontsize{220}{100}\sffamily\bfseries\thepart}; 
\node[anchor=south east] at (\paperwidth-1cm,-\paperheight+1cm){\parbox[t][][t]{8.5cm}{
\printcontents{l}{0}{\setcounter{tocdepth}{1}}% The depth to which the Part mini table of contents displays headings; 0 for chapters only, 1 for chapters and sections and 2 for chapters, sections and subsections
}};
\node[anchor=south] at (\paperwidth-10.5cm,-7.25cm){\parbox[t][][t]{15cm}{\strut\raggedright\color{white}\fontsize{30}{30}\sffamily\bfseries#2}};
\end{tikzpicture}};
\end{tikzpicture}}%
\@endpart}
\def\@spart#1{%
...
\usepackage{float}
\usepackage{hyperref}
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=true,breaklinks=true,linkcolor=ocre,urlcolor=ocre,bookmarks=true,bookmarksopen=false}
...
\definecolor{laurapurple}{rgb}{0.384, 0.380, 0.674}
